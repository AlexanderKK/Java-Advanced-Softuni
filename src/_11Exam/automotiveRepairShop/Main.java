...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(repairShop.removeVehicle("5YJSA1CN7DFP12345"));
        System.out.println(repairShop.removeVehicle("5YJSA1CN7DFP12345"));

        Vehicle vehicle10 = new Vehicle("1G1BL52P3RR123456", 80000, "Overheating issue");
        repairShop.addVehicle(vehicle10);

        Vehicle vehicle11 = new Vehicle("2G1BL52P3RR123456", 80000, "Overheating issue");
        repairShop.addVehicle(vehicle11);
    }
}
